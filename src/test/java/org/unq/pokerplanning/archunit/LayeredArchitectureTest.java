...
public class LayeredArchitectureTest {
    ...
    public static final ArchRule layer_dependencies_are_respected = Architectures.layeredArchitecture()
            .layer(CONFIG).definedBy("org.unq.pokerplanning.config..")
            .layer(DOMAIN).definedBy("org.unq.pokerplanning.domain..")
            .layer(ADAPTERS).definedBy("org.unq.pokerplanning.adapter..")
            .layer(APPLICATION).definedBy("org.unq.pokerplanning.application..")
